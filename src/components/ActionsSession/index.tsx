...
export default function ActionsSession() {
	return (
		<div
			className='flex flex-col items-center w-full h-[800px] pt-8 pb-8 lg:px-3 md:h-[800px]'
			style={{
		...
		>
			...
			>
				...
				<div className='grid grid-cols-1 w-full h-full gap-12 px-8 py-8 lg:w-4/5 lg:px-0 lg:flex lg:justify-center md:grid-cols-2'>
					<div className='w-full h-[450px] flex justify-center flex-col p-9 bg-[#F3F3F3] rounded-3xl'>
						...
						<span className='text-sm mt-16'>
							A verdadeira qualidade de vida no trabalho é o resultado de uma
